...
make_helper(decode_jm2r_w);
make_helper(decode_jm2r_l);

make_helper(decode_rmd2r_w);
make_helper(decode_rmd2r_l);

make_helper(decode_rmzd2r_w);
make_helper(decode_rmzd2r_l);

/*make_helper(decode_call2r_w);
make_helper(decode_call2r_l);*/
