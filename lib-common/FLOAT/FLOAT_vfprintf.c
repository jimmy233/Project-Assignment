...
//	printf("%x",f);
 ...
 int64_t f1;
   if(f>>31)
		 f1=((~((int64_t)f&0xffff)+1)&0xffff)*1000000/65536;  
   else
		 f1=((int64_t)f&0xffff)*1000000/65536;
	int len = sprintf(buf, "%d.%06d",F2int(f),f1);
...
static void modify_vfprintf() {
  ...
  uint32_t r1=(int)(format_FLOAT);
  uint32_t r2=&(_fpmaxtostr);
   uint32_t r3=&(_vfprintf_internal);
  int delta=r1-r2;
  if(delta>=0)
		  delta=-delta;
  // printf("%x\n",*((int*)(r3+775)));
  int rel16=*((int *)(r3+775));
  rel16=rel16+delta;
  *((int *)(r3+775))=rel16;
  // rel16=(rel16<<8)+*((int *)(r3+775));
   ...
   *((int8_t *)(r3+764))=0xff;
    ...
    *((int8_t *)(r3+740))=0x90;	
  // *((int *)(r3)
  // result=(result&0xff000000)+(0x009032ff);
  // *((int *)(r3+764))=result;
  /* uint32_t result1=*((int *)(r3+760));
   result1=(result1&0x00ffffff)+(0x08000000);
   *((int *)(r3+760))=result1;
 printf("%x\n",result);*/
//   printf("%x\n",*((int8_t *)(r3+745)));
 //  printf("%x\n",delta);
...
//uint32_t r4=&(_vfprintf_internal);
//  mprotect((void *)((r4+674)&0xfffff000), 4096*2, PROT_READ | PROT_WRITE | PROT_EXEC);
	modify_vfprintf();
	modify_ppfs_setargs();
}
